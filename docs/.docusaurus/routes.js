        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/features/scanning',
                component: ComponentCreator('/docs/features/scanning', '436'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/features/visualizations',
                component: ComponentCreator('/docs/features/visualizations', 'd31'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
